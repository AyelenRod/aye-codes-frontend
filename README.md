# 🚀 Mi Ruta de Aprendizaje: Frontend Developer

¡Hola! 👋 Soy **Ayelen** y este repositorio es mi bitácora personal donde documento mi camino desde cero hasta convertirme en desarrolladora Fullstack (React, Next.js, Tailwind).

Aquí guardo mis ejercicios, proyectos de práctica y notas técnicas de cada tecnología que voy dominando.

---

## 🗺️ Mapa del Repositorio (Ramas)
...
## 🛠️ Herramientas de mi entorno
* **Editor:** Visual Studio Code.
* **Control de Versiones:** Git & GitHub.
* **Navegador de pruebas:** Google Chrome (DevTools).
